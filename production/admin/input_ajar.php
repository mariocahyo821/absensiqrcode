                    ...
                    <div class="x_content">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <?php $ajar = query("SELECT nama_dosen FROM data_dosen"); ?>
                                <select class="form-control" name="nam_dos" id="nam_dos"> 
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input value="1" name="kls">
                            </div>
                        </div>
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">Mata Kuliah<span class="required"></span>
                            </label>
                            <div class="col-md-6 col-sm-6 ">
                                <input value="2" name="mk">
                            </div>
                        </div>
