...
$jumlahData = count(query("SELECT * FROM data_mahasiswa"));
...
$mhs = query("SELECT * FROM data_mahasiswa LIMIT $awalData, $jumlahDataPerHalaman");

if ( isset($_POST["cari"]) ) {
    $mhs = carimhs($_POST["cari_mhs"]);
}
                    ...
                    <div class="x_content">
                        ...
                        <div id="datatable-buttons_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap no-footer">
                          <div class="dt-buttons btn-group">
                            ...
                            <a class="btn btn-default buttons-excel buttons-html5 btn-sm" tabindex="0" aria-controls="datatable-buttons" href="#"><span>Excel</span></a>
                            <a class="btn btn-default buttons-pdf buttons-html5 btn-sm" tabindex="0" aria-controls="datatable-buttons" href="#"><span>PDF</span></a>
                            <a class="btn btn-default buttons-print btn-sm" tabindex="0" aria-controls="datatable-buttons" href="#"><span>Print</span></a></div><div class="dataTables_length" id="datatable-buttons_length">
                          </div>
                          <div class="row">
                            <div class="col-md-8">
                            <label><a class="btn btn-primary" href="input_mhs.php">Tambah Mahasiswa</a></label>
                           </div>
                           <div class="col-sm-4">
                            <div class="form-group">
                                <div class="input-group date" id="myDatepicker">
                                  <form action="" method="post" class="input-group">
                                    <input type="text" name="cari_mhs" class="form-control" placeholder="Search.." autofocus>
                          ...
                          <thead>
                            <tr role="row" align="center">
                              <th class="sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" width="1%" aria-sort="ascending" aria-label="Name: activate to sort column descending">No.</th>
                              <th class="sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" width="15%" aria-sort="ascending" aria-label="Name: activate to sort column descending">QR CODE</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" width="20%" aria-label="Position: activate to sort column ascending">Nama Mahasiswa</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" width="10%" aria-label="Office: activate to sort column ascending">NPM</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" width="10%" aria-label="Age: activate to sort column ascending">No. Hp</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" width="15%" aria-label="Office: activate to sort column ascending">Program Studi</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 50px;" aria-label="Salary: activate to sort column ascending">Option</th>
                            </tr>
                          </thead>
                          <?php $n = 1; ?>
                          ...
                          <tr role="row" class="odd" align="center">
                              ...
                              <td><?= $row["prodi"]?></td>
                              <td>
                                <a class="btn btn-warning" href="kartu_mhs.php?id_mhs=<?= $row["id_mhs"]; ?>" target="_blank"><i class="fa fa-print"></i></a>
                                <a class="btn btn-info" href="edit_mhs.php?id_mhs=<?= $row["id_mhs"]; ?>"><i class="fa fa-edit"></i></a>
                                <a class="btn btn-danger" href="hapus_mhs.php?id_mhs=<?= $row["id_mhs"]; ?>" onClick="return confirm('Yakin ingin Menghapus Data ini?');"><i class="fa fa-trash"></i></a>
                              </td>
                            </tr>
                          </tbody>
                          <?php $n++; ?>
