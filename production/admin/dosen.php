...
$jumlahData = count(query("SELECT * FROM data_dosen"));
...
$dosen = query("SELECT * FROM data_dosen LIMIT $awalData, $jumlahDataPerHalaman");
                  ...
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div id="datatable-buttons_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap no-footer">
                          ...
                          <div class="row">
                            <div class="col-md-8">
                            <label><a class="btn btn-primary" href="input_dosen.php" >Tambah Dosen</a></label>
                           </div>
                           <div class="col-sm-4">
                            <div class="form-group">
                                <div class="input-group date" id="myDatepicker">
                                  <form action="" method="post" class="input-group">
                                    <input type="text" name="cari_dosen" class="form-control" placeholder="Search.." autofocus>
                          ...
                          <thead>
                            <tr role="row">
                              <th aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 0px;" >No.</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 80px;" aria-label="Position: activate to sort column ascending">Nama Dosen</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 15px;" aria-label="Age: activate to sort column ascending">No. Hp</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 0px;" aria-label="Office: activate to sort column ascending">Jenis Kelamin</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 27px;" aria-label="Age: activate to sort column ascending">Tanggal Lahir</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 0px;" aria-label="Salary: activate to sort column ascending">Option</th>
                            </tr>
                          </thead>
                          <?php $n = 1; ?>
                          ...
                          <tr role="row" class="odd">
                              ...
                              <td><?= $row["tgl_lahir"]?></td>
                              <td>
                                <a class="btn btn-info" href="edit_dosen.php?id_dosen=<?= $row["id_dosen"]; ?>"><i class="fa fa-edit"></i></a>
                                <a class="btn btn-danger" href="hapus_dosen.php?id_dosen=<?= $row["id_dosen"]; ?>" onClick="return confirm('Yakin ingin Menghapus Data ini?');"><i class="fa fa-trash"></i></a>
                              </td>
                            </tr>
                          </tbody>
                          <?php $n++; ?>
