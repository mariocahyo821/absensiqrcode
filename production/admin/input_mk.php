                    ...
                    <div class="x_content">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input type="text" class="form-control" name="nama_mk" id="nama_mk" require autocomplate="off">
                            </div>
                        </div>
                        <div class="item form-group">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input type="number" required="required" class="form-control" name="sks" id="sks">
                            </div>
                        </div>
                        <p>&nbsp;</p>
                        <div class="item form-group">
