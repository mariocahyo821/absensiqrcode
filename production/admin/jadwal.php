...
$jumlahData = count(query("SELECT * FROM data_jadwal"));
                        ...
                        <div id="datatable-buttons_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap no-footer">
                            ...
                            <div class="form-group">
                                <div class="input-group date" id="myDatepicker">
                                  <form action="" method="post" class="input-group">
                                    <input type="text" name="cari_jadwal" class="form-control" placeholder="Search.." autofocus>
                          ...
                          <thead>
                            <tr role="row">
                              ...
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 69px;" aria-label="Office: activate to sort column ascending">Hari</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 20px;" aria-label="Age: activate to sort column ascending">Jam</th>
