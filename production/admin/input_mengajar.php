        ...
        if ( tambahajar ($_POST) > 0 ) {
            ...
            echo "
                <script>
                    ...
                    document.location.href = 'input_mengajar.php';
                </script>
            "; 
        }
    }
                  ...
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">Mengajar <span class="required"></span>
                            </label>
                            <div class="col-md-3 col-sm-2 ">
                            <?php $kelas = query("SELECT kelas FROM data_kelas"); ?>
                            ...
                            <div class="col-md-3 col-sm-2 ">
                                <input type="number" id="semester" class="form-control" name="semester" required="" placeholder="Semester">
                            </div>
                        </div>
