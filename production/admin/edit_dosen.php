...
$id_dosen = $_GET["id_dosen"];
    ...
    $dosen = query("SELECT * FROM data_dosen WHERE id_dosen = $id_dosen")[0];
    $ajar = query("SELECT * FROM data_ajar 
                    INNER JOIN data_dosen ON data_ajar.id_dosen = data_ajar.id_dosen
                    ");
        ...
        if (edit_dosen ($_POST) > 0 ) {
            ...
            echo "
                <script>
                    ...
                    document.location.href = 'edit_dosen.php';
                </script>
            "; 
        }
    }
                  ...
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Nama Dosen <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 ">
                                <input type="text" required="required" class="form-control " name="nama_dosen" id="nama_dosen" value = "<?= $dosen["nama_dosen"]; ?>">
                            </div>
                        </div>
                        <div class="item form-group">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Nomer Hp</label>
                            <div class="col-md-6 col-sm-6 ">
                                <input class="form-control" type="text" name="no_hp" id="no_hp" value = "<?= $dosen["no_hp"]; ?>">
                            </div>
                        </div>
                        <div class="item form-group">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Jenis Kelamin</label>
                            <div class="col-md-6 col-sm-6 ">
                                <select name="jenkel" id="jenkel" class="form-control" value = "<?= $dosen["jenkel"]; ?>">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input type="date" id="tgl_lahir" class="form-control" name="tgl_lahir" required="" value = "<?= $dosen["tgl_lahir"]; ?>">
                            </div>
                        </div>
