                        ...
                        <div class="row">
                          ...
                          <thead>
                            <tr role="row" align="center">
                              ...
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 69px;" aria-label="Office: activate to sort column ascending">Option</th>
                            </tr>
                          </thead>
                          <?php $n = 1; ?>
                          ...
                          <tr role="row" class="odd">
                              ...
                              <td><?= $row["time"]?></td>
                              <td align="center">
                                  <a class="btn btn-danger" href="hapus_absen.php?id=<?= $row["id"] ;?>" onClick = "return confirm('Yaking Ingin Menhapus data ini ?');"><i class="fa fa-trash"></i></a>
                              </td>
                            </tr>
                          </tbody>
                          <?php $n++; ?>
