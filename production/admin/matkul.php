...
$matkul = query("SELECT * FROM data_matakuliah LIMIT $awalData, $jumlahDataPerHalaman");

if ( isset($_POST["cari"]) ) {
    $matkul = cari_mk($_POST["cari_matkul"]);
}
                  ...
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div id="datatable-buttons_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap no-footer">
                          ...
                          <div class="row">
                            <div class="col-md-8">
                            <label><a class="btn btn-primary" href="input_mk.php" >Tambah Mata Kuliah</a></label>
                           </div>
                           <div class="col-sm-4">
                            <div class="form-group">
                                <div class="input-group date" id="myDatepicker">
                                  <form action="" method="post" class="input-group">
                                    <input type="text" name="cari_matkul" class="form-control" placeholder="Search.." autofocus>
                          ...
                          <thead>
                            <tr role="row" align="center">
                              ...
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 100px;" aria-label="Position: activate to sort column ascending">Mata Kuliah</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 120px;" aria-label="Position: activate to sort column ascending">Dosen</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" width="5%" aria-label="Office: activate to sort column ascending">SKS</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 20px;" aria-label="Age: activate to sort column ascending">Jenis</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" width="5%" aria-label="Office: activate to sort column ascending">Semester</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 80px;" aria-label="Salary: activate to sort column ascending">Option</th>
                            </tr>
                          </thead>
                          <?php $n = 1; ?>
                          ...
                          <tr role="row" class="odd" align="center">
                              ...
                              <td align="left"><?= $row["dosen"]; ?></td>
                              <td><?= $row["sks"]?></td>
                              <td><?= $row["jenis"]?></td>
                              <td><?= $row["semester"]?></td>
                              <td>
                                <a class="btn btn-warning" href="input_jadwal.php?id_mk=<?= $row["id_mk"] ?>"><i class="fa fa-calendar"></i></a>
                                <a class="btn btn-info" href="edit_matkul.php?id_mk=<?= $row["id_mk"]; ?>"><i class="fa fa-edit"></i></a>
                                <a class="btn btn-danger" href="hapus_mk.php?id_mk=<?= $row["id_mk"]; ?>" onClick="return confirm('Yakin ingin Menghapus Data ini?');"><i class="fa fa-trash"></i></a>
                              </td>
                            </tr>
                          </tbody>
                          <?php $n++; ?>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Tambah Ke Jadwal</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <div class="modal-body">
                <form role="form" action="" method="get"></form>
                <?php 

                $id_mk = $_GET['id_mk'];
                $mk = query("SELECT * FROM data_matakuliah WHERE id_mk = $id_mk")[0];
