...
$jumlahData = count(query("SELECT * FROM data_ajar"));
...
$ajar = query("SELECT * FROM data_ajar 
                INNER JOIN data_dosen ON data_ajar.id_dosen = data_dosen.id_dosen
                ORDER BY id_ajar DESC LIMIT $awalData, $jumlahDataPerHalaman");

if ( isset($_POST["cari"]) ) {
    $ajar = cariajar($_POST["cari_ajar"]);
}
                        ...
                        <div id="datatable-buttons_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap no-footer">
                            ...
                            <div class="form-group">
                                <div class="input-group date" id="myDatepicker">
                                  <form action="" method="post" class="input-group">
                                    <input type="text" name="cari_ajar" class="form-control" placeholder="Search.." autofocus>
                          ...
                          <thead>
                            <tr role="row" align="center">
                              <th class="sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" width="3%" aria-sort="ascending" aria-label="Name: activate to sort column descending">No.</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 140px;" aria-label="Position: activate to sort column ascending">Nama Dosen</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 0px;" aria-label="Office: activate to sort column ascending">Kelas</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" width="10%" aria-label="Age: activate to sort column ascending"> Semester</th>
                          ...
                          <tr role="row" class="odd">
                              ...
                              <td align="center">
                                ...
                                <a class="btn btn-info" href="edit_ajar.php?id_ajar=<?= $row["id_ajar"]; ?>"><i class="fa fa-edit"></i></a>
                                <a class="btn btn-danger" href="hapus_ajar.php?id_ajar=<?= $row["id_ajar"]; ?>" onClick="return confirm('Yakin ingin Menghapus Data ini?');"><i class="fa fa-trash"></i></a>
                              </td>
                            </tr>
                          </tbody>
                          <?php $n++; ?>
