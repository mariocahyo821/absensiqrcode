                  ...
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Nama Mahasiswa <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 ">
                                <input type="text" required="required" class="form-control " name="nama_mhs" id="nama_mhs" value = "<?= $mhs["nama_mhs"]; ?>">
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input type="text" required="required" class="form-control" name="npm" id="npm" value = "<?= $mhs["npm"]; ?>">
                            </div>
                        </div>
                        <div class="item form-group">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">No. Telp</label>
                            <div class="col-md-6 col-sm-6 ">
                                <input class="form-control" type="text" name="no_telp" id="no_telp" value = "<?= $mhs["no_telp"]; ?>">
                            </div>
                        </div>
                        <div class="item form-group">
