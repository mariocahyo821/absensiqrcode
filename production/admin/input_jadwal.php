              ...
              <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <input Type="hidden" name="id_mk" id="id_mk" value="<?= $mk["id_mk"] ?>">
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">Nama Mata Kuliah <span class="required"></span>
                            </label>
                            <div class="col-md-6 col-sm-6 ">
                                <input type="text" class="form-control" name="nama_matkul" id="nama_matkul" value="<?= $mk["nama_mk"] ?>" require autocomplate="off" disabled>
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input type="text" class="form-control" name="nam_dos" id="nam_dos" value="<?= $mk["dosen"] ?>" require autocomplate="off" disabled>
                            </div>
                        </div>
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" >Jam
                            </label>
                            <div class="col-md-6 col-sm-6 ">
                                <input type="time" required="required" class="form-control" name="jam" id="jam">
                            </div>
                        </div>
                        <div class="item form-group">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Hari</label>
                            <div class="col-md-6 col-sm-6 ">
