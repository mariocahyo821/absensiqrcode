            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="scan.php"><i class="fa fa-camera"></i> Scan QRCODE</a></li>

                  <li><a href="general_elements.html"><i class="fa fa-table"></i> History Absensi</a></li>
                </ul>
              </div>
                    ...
                    <table class="table table-striped projects">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="project_progress">
                            <div class="progress progress_sm">
                              <div class="progress-bar bg-green" role="progressbar" data-transitiongoal="47" aria-valuenow="45" style="width: 47%;"></div>
                            </div>
                        ...
                        <tr>
                          ...
                          <td class="project_progress">
                            <div class="progress progress_sm">
                              <div class="progress-bar bg-green" role="progressbar" data-transitiongoal="77" aria-valuenow="75" style="width: 77%;"></div>
                            </div>
                        ...
                        <tr>
                          ...
                          <td class="project_progress">
                            <div class="progress progress_sm">
                              <div class="progress-bar bg-green" role="progressbar" data-transitiongoal="35" aria-valuenow="33" style="width: 35%;"></div>
                            </div>
                        ...
                        <tr>
                          ...
                          <td class="project_progress">
                            <div class="progress progress_sm">
                              <div class="progress-bar bg-green" role="progressbar" data-transitiongoal="87" aria-valuenow="85" style="width: 87%;"></div>
                            </div>
